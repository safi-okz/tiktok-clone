    ...
    <div id="PostPage" 
        ...
        <div v-if="$generalStore.selectedPost" class="lg:w-[calc(100%-540px)] h-full relative">
            ...
            <img 
                ...
                width="45" 
                src="~/assets/img/tiktok-logo-small.png"
            >
        ...
        <div id="InfoSection" 
            ...
            <div id="Comments" 
                ...
                <button
                    :disabled="!comment"
                    @click="addComment($generalStore.selectedPost.id)"
...
const deleteComment = async (post, commentId) =>{
    ...
    try{
        if(res){
            console.log('comment iddddddddddd ', commentId)
...
const deletePost = async () => {
    let res = confirm('Are you sure want to delete the post');
    try{
        if(res){
