            ...
            <div class="mt-2.5 flex">
                <div
                    ...
                    <video 
                           ...
                           muted 
                           :src="post.video" 
                           class="rounded-xl object-cover mx-auto h-full"></video>
                    <img src="../assets/img/tiktok-logo-white.png" width="90" alt="" class="absolute right-2 bottom-14">
                </div>
...
onMounted(() => {
    let observer = new IntersectionObserver(function(entries){
        if(entries[0].isIntersecting){
            ...
            console.log('Element is pused ', post.value.id);
            video.value.pause();
        }
    }, { threshold: [0.6]});
